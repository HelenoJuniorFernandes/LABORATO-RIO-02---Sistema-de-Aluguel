...
![Micronaut](https://img.shields.io/badge/Micronaut-4.x-black?style=for-the-badge&logo=micronaut)
...
Alunos: Heleno Junior e Nalanda Santos
...
* **Backend**:
    * Java 17+
    * Micronaut 4.x
    * Micronaut Security (para autenticação e autorização)
    * Micronaut Data JPA / Hibernate (para persistência de dados)
* **Frontend**:
...
* `com.pucminas.rental_system.config`: Configurações de segurança (Micronaut Security).
...
* `com.pucminas.rental_system.repository`: Interfaces do Micronaut Data JPA para acesso ao banco de dados.
